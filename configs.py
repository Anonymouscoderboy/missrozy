...
class Config(object):
	...
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1001890815456))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "5965340120"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://filestortebot:filestortebot@cluster0.tdmgwvj.mongodb.net/?retryWrites=true&w=majority")
...
🚀 **ʜᴏꜱᴛᴇᴅ ᴏɴ :** [ʜᴇʀᴏᴋᴜ](https://app.koyeb.com)
🧑🏻‍💻 **ᴅᴇᴠᴇʟᴏᴘᴇʀ :** [ᴄʀᴀᴢʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ​](https://t.me/heartlesssn)</b>"""
	
	ABOUT_DEV_TEXT = f"""<b>💵 ɪ ʀᴇǫᴜᴇsᴛᴇᴅ ᴛᴏ ʏᴏᴜ 💸
...
ꜱᴇɴᴅ ᴍᴇ ᴀɴʏ ꜰɪʟᴇ ɪ ᴡɪʟʟ ꜱᴀᴠᴇ ɪᴛ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀꜱᴇ. ᴀʟꜱᴏ ᴡᴏʀᴋꜱ ꜰᴏʀ ᴄʜᴀɴɴᴇʟ. ᴀᴅᴅ ᴍᴇ ᴛᴏ ᴄʜᴀɴɴᴇʟ ᴀꜱ ᴀᴅᴍɪɴ ᴡɪᴛʜ ᴇᴅɪᴛ ᴘᴇʀᴍɪꜱꜱɪᴏɴ, ɪ ᴡɪʟʟ ᴀᴅᴅ ꜱᴀᴠᴇ ᴜᴘʟᴏᴀᴅᴇᴅ ꜰɪʟᴇ ɪɴ ᴄʜᴀɴɴᴇʟ & ᴀᴅᴅ ꜱʜᴀʀᴀʙʟᴇ ʙᴜᴛᴛᴏɴ ʟɪɴᴋ.</b>"""
